...
const firebaseConfig = {
  ...
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID?.trim() || "cfd-treats-hub",
  storageBucket: "cfd-treats-hub.firebasestorage.app",
  messagingSenderId: "42357304413",
};

// Defer Firebase service creation until it is used so missing client config
// does not crash every server-rendered route during module evaluation.
